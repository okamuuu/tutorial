...
[![Build Status](https://travis-ci.org//famous-base.svg?branch=master)](https://travis-ci.org//famous-base) [![Dependency Status](https://david-dm.org//famous-base.svg)](https://david-dm.org//famous-base) [![devDependency Status](https://david-dm.org//famous-base/dev-status.svg)](https://david-dm.org//famous-base#info=devDependencies)
...
## Release History
 * 2014-06-23   v0.1.0   Generated by the [Yeoman Generator](https://github.com/famous/generator-famous) for [Famo.us](http://famo.us)